...
public class GlobalPara {
    ...
    public static final String INIT_GLOBAL_SCHEMA = "macaque";

    public static final String INIT_FORMAT_GLOBAL_SCHEMA_SQL = "create database" + INIT_GLOBAL_SCHEMA +
            " if not exists macaque";
    ...
    public static final Map<String, Integer> SPECIAL_TABLE_FIELD_NUMBER = new HashMap<> ();
